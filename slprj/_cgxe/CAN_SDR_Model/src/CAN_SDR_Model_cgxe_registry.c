...
static mxArray* cgxe_get_supported_modules(void)
{
  ...
  checksumData[0] = 3480284251;
  checksumData[1] = 2893830111;
  checksumData[2] = 1184501711;
  checksumData[3] = 3460970550;
  ...
  mxArray* prhs[])
{
...

  {
    ...
    checksumData[0] = 305783354;
    checksumData[1] = 2603801252;
    checksumData[2] = 1889022385;
    checksumData[3] = 2638962930;
...

  {
    ...
    checksumData[0] = 2778152974;
    checksumData[1] = 2496162582;
    checksumData[2] = 1879458210;
    checksumData[3] = 1977482103;
...

  {
    ...
    checksumData[0] = 1890240882;
    checksumData[1] = 2450695843;
    checksumData[2] = 3662024927;
    checksumData[3] = 1019048554;
  ...
  mxArray * prhs[])
{
  ...
  if (strcmp(tpChksum, "RYJJYzCHWak9uzULp4keoE") == 0) {
    extern mxArray *cgxe_RYJJYzCHWak9uzULp4keoE_BuildInfoUpdate(void);
    plhs[0] = cgxe_RYJJYzCHWak9uzULp4keoE_BuildInfoUpdate();
    return 1;
  }
  ...
  mxArray * prhs[])
{
  ...
  tpChksum[(sizeof(tpChksum)/sizeof(char)-1)] = '\0';
  if (strcmp(tpChksum, "RYJJYzCHWak9uzULp4keoE") == 0) {
    extern mxArray *cgxe_RYJJYzCHWak9uzULp4keoE_fallback_info(void);
    plhs[0] = cgxe_RYJJYzCHWak9uzULp4keoE_fallback_info();
    return 1;
  }
