...
set COMPILER=C:\ProgramData\MATLAB\SupportPackages\R2024a\3P.instrset\mingw_w64.instrset\bin\gcc
                ...
                set LINKFLAGS=-m64 -Wl,--no-undefined -shared -static -L"C:\Program Files\MATLAB\R2024a\extern\lib\win64\mingw64" -llibmx -llibmex -llibmat -lm -llibmwlapack -llibmwblas -Wl,"C:\Program Files\MATLAB\R2024a/extern/lib/win64/mingw64/mexFunction.def"
                set LINKDEBUGFLAGS=-g
                set NAME_OUTPUT=-o "%OUTDIR%%MEX_NAME%%MEX_EXT%"
set PATH=C:\ProgramData\MATLAB\SupportPackages\R2024a\3P.instrset\mingw_w64.instrset\bin;C:\Program Files\MATLAB\R2024a\extern\include\win64;C:\Program Files\MATLAB\R2024a\extern\include;C:\Program Files\MATLAB\R2024a\simulink\include;C:\Program Files\MATLAB\R2024a\lib\win64;%MATLAB_BIN%;%PATH%
...
gmake SHELL="cmd" -f CAN_SDR_Model_revised_cgxe.gmk
